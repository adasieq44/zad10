...
class Manager:
    ...
    def create_tenants_settlements(
        ...
        return [
            TenantSettlement(
                tenant=tenant.name,  # set tenant name as tenant settlement tenant field
                apartment_settlement=apartment_settlement.key,  # set apartment settlement key as tenant settlement apartment settlement field
                month=apartment_settlement.month,  # set month as apartment settlement month
                year=apartment_settlement.year,  # set year as apartment settlement year
                total_due_pln=apartment_settlement.total_due_pln  # add total due from apartment settlement and then divide by number of tenants in the apartment
